...
export const PHONE_NUMBERS_REQUEST = 'PHONE_NUMBERS_REQUEST';
export const PHONE_NUMBERS_SUCCESS = 'PHONE_NUMBERS_SUCCESS';
export const PHONE_NUMBERS_FAIL = 'PHONE_NUMBERS_FAIL';
export const PHONE_NUMBERS_RESET = 'PHONE_NUMBERS_RESET';